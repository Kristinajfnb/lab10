<?php
/**
 * Обрабатывает отправку формы добавления мероприятия.
 *
 * Эта функция получает данные из формы добавления мероприятия, проверяет их наличие и подключается к базе данных для сохранения мероприятия.
 *
