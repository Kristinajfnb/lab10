 ...
 *
 * Этот скрипт проверяет отправленную форму для входа пользователя.
 * Он подключается к базе данных, проверяет введенные учетные данные
 * и, если они верны, перенаправляет пользователя на административную панель.
